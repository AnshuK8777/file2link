...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN','basic-korry-a4anshu.koyeb.app') else APP_NAME+'.herokuapp.com'
...
class Config(object):
	API_ID = int(os.environ.get("API_ID", 1013966))
	API_HASH = os.environ.get("API_HASH", "52102f76ad963d710d42caf7e8e2324b")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6735872089:AAEIhcAvPd7nTvl2q8I0AP9F-WFwAG9IzFY")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "ak_link_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002024450241))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "6715713856"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://a4anshu:8ijn9okm0pl@cluster0.krkhtcl.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002117585427")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001875452827")
...
🤖 **ᴍʏ ɴᴀᴍᴇ:** [ғɪʟᴇ ᴛᴏ ʟɪɴᴋ ʙᴏᴛ](https://t.me/{ak_link_bot})
...
🧑🏻‍💻 **DΞVΞLФPΞЯ:** [🅰🅽🆂🅷🆄](https://t.me/a4_anshu_op)

👥 **šupp⊕r† gr⊕up:** [ＡＫ ＯＦＦＩＣＩＡＬ](https://t.me/a4_ak_official)

📢 **U͢p͢d͢a͢t͢e͢s͢ C͢h͢a͢n͢n͢e͢l͢:** [ＡＫ ＯＦＦＩＣＩＡＬ](https://t.me/a4_ak_official)
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 <a href='https://t.me/a4_anshu_op'>**ミ★- 🅰🅽🆂🅷🆄 -★彡** </a>

<a href=''hhttps://t.me/a4_anshu_op>🅰🅽🆂🅷🆄</a> ɪꜱ ꜱᴜᴘᴇʀ ɴᴏᴏʙ 😎. ᴊᴜꜱᴛ ʟᴇᴀʀɴɪɴɢ ꜰʀᴏᴍ ᴏꜰꜰɪᴄɪᴀʟ ᴅᴏᴄꜱ. ᴘʟᴇᴀꜱᴇ ᴅᴏɴᴀᴛᴇ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ ꜰᴏʀ ᴋᴇᴇᴘɪɴɢ ᴛʜᴇ ꜱᴇʀᴠɪᴄᴇ ᴀʟɪᴠᴇ.
ᴀʟꜱᴏ ʀᴇᴍᴇᴍʙᴇʀ ᴛʜᴀᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴡɪʟʟ ᴅᴇʟᴇᴛᴇ ᴀᴅᴜʟᴛ ᴄᴏɴᴛᴇɴᴛꜱ ꜰʀᴏᴍ ᴅᴀᴛᴀʙᴀꜱᴇ. ꜱᴏ ʙᴇᴛᴛᴇʀ ᴅᴏɴ'ᴛ ꜱᴛᴏʀᴇ ᴛʜᴏꜱᴇ ᴋɪɴᴅ ᴏꜰ ᴛʜɪɴɢꜱ.
[Donate Now](https://paytm.me/WwI-lue) (Paytm)
"""
	LAZY_HOME_TEXT = """
